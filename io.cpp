...
void show_help(){
    ...
    cout<<"ycmd -f(--file) [plik] - wykonaj wiersze z pliku"<<endl;
    cout<<"ycmd -y(--ymake) [ymake] - stworz na podstawie pliku ymake"<<endl;
    cout<<"ycmd --generate [ymake] [output.bat] - stworz plik .bat na podstawie pliku ymake"<<endl;
    cout<<"ycmd -t(--time) [polecenie] - czas wykonania polecenia"<<endl;
    ...
    cout<<"ycmd --version++ [version] - zwiększ numer wersji w pliku"<<endl;
